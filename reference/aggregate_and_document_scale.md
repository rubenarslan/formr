...
Copied from codebook. The resulting variables will have the attribute
`scale_item_names` containing the basis for aggregation. Its `label`
attribute will refer to the common stem of the aggregated variable names
(if any), the number of variables, and the aggregation function.
...
testdf$bfi_neuro
#>  [1] -0.006951671 -1.263924018  0.160240530  0.984951589  1.268794692
#>  [6] -0.903711211  0.104811152 -0.317597895 -1.235608530  0.414583429
#> [11]  0.187411304  0.700874388  0.003912358  0.218008596 -0.482393654
#> [16] -1.568738280  0.783572677 -0.043890297  0.122196267  0.537511718
