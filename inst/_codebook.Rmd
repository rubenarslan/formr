...
```{r}
missingness = pander::pander(missingness_patterns(results[!is.na(results$ended), ] ))
```
```{r}
missingness
```
...
```{r}
missingness = pander::pander(missingness_patterns(results[!is.na(results$modified), ] ))
```
```{r}
missingness
```
