...
#'
#' Custom rmarkdown input format options based on the standard [rmarkdown::html_document()], but with options that you can specify. Find the format options here in the pandoc documentation: <https://pandoc.org/MANUAL.html#pandocs-markdown>.
...
#'
#' @return An rmarkdown `output_format` object (from [rmarkdown::html_document()]/`html_fragment()`) with customised pandoc/knitr options.
#' @export
...
#' @param ... all other arguments passed to [rmarkdown::html_document()]
#'
#' @return An rmarkdown `output_format` object configured for GitHub-flavoured markdown.
#' @export
...
#' @param ... all other arguments passed to [rmarkdown::html_document()]
#' 
#' @return An rmarkdown `output_format` object with hard line breaks enabled.
#' @export
...
#' 
#' @return A length-1 character string of rendered HTML.
#' @export
...
#' 
#' @return A length-1 character string of knitted markdown.
#' @export
...
#' 
#' @return A length-1 character string of HTML rendered from CommonMark.
#' @export
#' @examples 
...
#' 
#' @return A length-1 character string of knitted output, with figure/cache paths prefixed by the input file name.
#' @export
#' @import knitr
#' 
...
#' @param break_on_error should an error in the R code execution interrupt the rendering or should rendering continue, defaults to FALSE
#'
#' @return An rmarkdown `output_format` object like [rmarkdown::word_document()], with an added option not to break on error.
#' @export
...
#'
#' @return A length-1 character string of class `knit_asis` (the knitted child document).
#' @export
#' @examples
#' \dontrun{
...
#'
#' @return A length-1 character string of class `knit_asis` (the inputs concatenated).
#' @export
#' @examples
...
#' @param ... ignored
#' 
#' @return Invisibly `NULL`; called for its side effect of printing the `knit_asis` content.
#' @export
